...
<title>Modifier client</title>
	...
	<body>
		<div class="row">
			<h2 class="col-md-8">Modifier un client</h2>
		</div>
		
		<div class="row">
			<form:form role="form"
				action="${pageContext.request.contextPath}/listClients/edit/${client.id}" method="POST"
				commandName="client">
				...
				<button type="submit" class="btn btn-default">Confirmer modifications?</button>
